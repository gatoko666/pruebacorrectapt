        ...
        <div class="wrapper">
         ...
         <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Operadores Externos  </h4>
                    @if ($errors->any())
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                              ...
                                              <form action="{{ route('operadorexternos.destroy', $opex ?? 0)}}" method="post">
                                                  {{ csrf_field() }}
                                                  @method('DELETE')
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <section class="grids-section bd-content">
                                                        ...
                                                        <div class="outer-w3-agile mt-3">
                                                            ...
                                                            <div class="container">
                                                                <form action="{{ route('operadorexternos.store') }}" method="POST">
                                                                        @csrf
                                                                            ...
                                                                            <div class="form-group row">
                                                                              ...
                                                                              <div class="col-sm-5">
                                                                                <input type="text" name="RutOperadorExterno" class="form-control" id="inputrut"  onfocus="this.value=''"  placeholder="Rut">
                                                                              </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                              ...
                                                                              <div class="col-sm-5">
                                                                                <input type="text"  name="TelefonoOperadorEX" class="form-control" id="inputtelefono"   onfocus="this.value=''" placeholder="Teléfono">
                                                                              </div>
                                                                            </div> 
                                                                            ...
                                                                            <div class="form-group row">
                                                                              ...
                                                                              <div class="col-sm-5">
                                                                                      <p align="justify"><select name="EstadoCuentaOperadorEX" size="1">
                                                                          ...
                                                                          <div class="form-group row">
                                                                              ...
                                                                              <div class="col-sm-5">
                                                                                <input type="text" name="LocalizacionExterno" class="form-control" id="inputlocalizacion"   onfocus="this.value=''" placeholder="Localización">
                                                                              </div>
                                                                            </div>                                                     </div>
